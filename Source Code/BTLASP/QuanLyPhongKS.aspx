<%@ Page Title="" Language="C#" MasterPageFile="~/QuanLy.master" AutoEventWireup="true" CodeBehind="QuanLyPhongKS.aspx.cs" Inherits="BTLASP.WebForm4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="auto-style8">
            <div class="tieudephong">
                <div class="trai">
                    <asp:Image ID="Image1" runat="server"  ImageUrl="~/images/tichto.png"/>
                    <asp:Label ID="Label14" runat="server" Text="Trang quản lý thông tin phòng." Font-Bold="True" Font-Size="Larger"></asp:Label>
                </div>
                <div class="phai">
                    <asp:Image ID="Image2" runat="server"  ImageUrl="~/images/mota-phong.png"/>
                </div>
            </div> 
        <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/ThemPhongAdmin.aspx" BackColor="#9933ff" ForeColor="White">Thêm Phòng</asp:HyperLink>
                    ...
                    <table class="auto-style1">
                        <tr>
                            ...
                            <td style="width:5%;text-align:right;color:blue" >
                                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%#"~/DanhsachPhong.aspx?Id=" + Eval("MaPhong").ToString() %>'>Xem chi tiết</asp:HyperLink>
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
